/***********************************************************************
CustomMapGame.h - Controller for a Sandbox mapping / Island game
...
#ifndef _CustomMapGame_h_
#define _CustomMapGame_h_
